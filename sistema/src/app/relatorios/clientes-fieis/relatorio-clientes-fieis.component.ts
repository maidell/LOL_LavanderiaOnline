...
export class RelatorioClientesFieisComponent implements OnInit {
    ...
    constructor(private titleService: TitleService, private authService: AuthService, private orderService: OrderService) { }

    ngOnInit(): void {

            this.titleService.setTitle('Relatorio de clientes fieis');
